...
#SBATCH -e logs/vcontact2.ICTV.log
#SBATCH -o logs/vcontact2.ICTV.log
#SBATCH --mem 50G #memory per node in Gb
#SBATCH -p intel
#SBATCH -J ictv_vcontact2



DIR=cyano
OUT=cyano_vcontact2_ictv
PREFIX=TC_plus_1Aug2022_ICTV
OUTFILE=TC_plus_1Aug2022_ICTV_prot.fa
...
#cat $DIR/$PREFIX.gene2genome.csv 1Aug2022_vConTACT2_gene_to_genome.csv
